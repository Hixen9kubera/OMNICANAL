...
const COLS: { id: string; label: string; num?: boolean; ayuda: string }[] = [
  ...
  { id: "sku", label: "SKU",
    ayuda: "Clave del producto. Une el mismo artículo entre Woo, Mercado Libre y Amazon." },
  { id: "titulo", label: "Producto",
    ayuda: "Título del catálogo maestro. Si aparece vacío, el SKU vendió pero no está dado de alta en core.products." },
