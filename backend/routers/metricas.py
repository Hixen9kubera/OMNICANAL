...
Mercado Libre por cuenta (BEKURA / SANCORFASHION / consolidado).
  ...
  GET /api/analisis/metricas → activaciones (por fecha REAL de publicación,
                                ...
                                channel.listing_history) y ticket promedio
                                (snapshot de listings activos), con
                                comparativo vs la semana anterior.
...
async def metricas(
    ...
    activaciones, pausas, activaciones_prev, pausas_prev, ticket_rows = await asyncio.gather(
