...
General vuelve a decir `PRECIO QUE COBRA HOY` con el precio rebajado de la
tienda, y el margen bruto vuelve a calcularse contra ese mismo número.

Queda como estaba en v0.301.0: **el precio que se muestra y el que se usa para el
margen son el mismo**, que es la invariante que v0.282.1 dejó escrita después de
que la tarjeta contradijera a la publicación de abajo.

Lo que la v0.303.0 intentaba sigue siendo cierto y sin resolver: con el precio
rebajado, el margen de `ORG-0319-PLA` mezcla el margen del producto (−15.9%
contra su lista de $166.20) con el costo de la promoción (los 25 puntos hasta
−41.3%). Separarlos requiere una decisión de producto que no se tomó aquí —
mostrar dos números, no cambiar cuál se muestra.
